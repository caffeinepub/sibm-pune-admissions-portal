...
export class Backend implements backendInterface {
    ...
    async addApplication(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addApplication(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async lookupApplication(arg0: string): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.lookupApplication(arg0);
